...
import static com.oocourse.library3.LibraryReqCmd.Type.QUERIED;
import static com.oocourse.library3.LibraryReqCmd.Type.RETURNED;
import static com.oocourse.library3.LibraryReqCmd.Type.RESTORED;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command instanceof LibraryOpenCmd) {
                ...
                library.queryCreditScore(today, command);
            } else {
